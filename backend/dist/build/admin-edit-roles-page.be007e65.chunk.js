(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[6823],{54729:(V,$,s)=>{"use strict";s.d($,{g:()=>O});var e=s(21272),y=s(90602),b=s(54894),f=s(74930);const O=(A={},x={})=>{const{id:C="",...T}=A,{get:k}=(0,y.ry)(),{locale:a}=(0,b.A)(),F=(0,y.QM)(a,{sensitivity:"base"}),{data:u,error:S,isError:N,isLoading:g,refetch:R}=(0,f.useQuery)(["roles",C,T],async()=>{const{data:Q}=await k(`/admin/roles/${C??""}`,{params:T});return Q},x);return{roles:e.useMemo(()=>{let Q=[];return u&&(Array.isArray(u.data)?Q=u.data:Q=[u.data]),[...Q].sort((oe,ee)=>F.compare(oe.name,ee.name))},[u,F]),error:S,isError:N,isLoading:g,refetch:R}}},59945:(V,$,s)=>{"use strict";s.d($,{R:()=>b});var e=s(90602),y=s(74930);const b=(f={id:null},O={})=>{const{id:A,...x}=f,{get:C}=(0,e.ry)(),{data:T,error:k,isError:a,isLoading:F,refetch:u}=(0,y.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await C(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:T,error:k,isError:a,isLoading:F,refetch:u}}},12370:(V,$,s)=>{"use strict";s.r($),s.d($,{CreatePage:()=>me,default:()=>Te});var e=s(21272),y=s(55794),b=s(43121),f=s(43242),O=s(69564),A=s(32559),x=s(44370),C=s(57842),T=s(57564),k=s(68065),a=s(81926),F=s(168),u=s(90602),S=s(95065),N=s(6103),g=s(61535),R=s(77965),Y=s.n(R),Q=s(54894),oe=s(82437),ee=s(17703),v=s(63891),de=s(71526),Z=s(89800),te=s(91125),X=s(59945),ue=s(12083);const Le=ue.Ik().shape({name:ue.Yj().required(u.iW.required),description:ue.Yj().required(u.iW.required)}),ce=v.Ay.div`
...
`,F=({children:u,disabled:S=!1,error:N,expanded:g=!1,hasErrorMessage:R=!0,id:Y,onToggle:Q,toggle:oe,size:ee="M",variant:v="primary",shadow:de})=>{const Z=(0,O.B)(Y),te=y.useMemo(()=>({expanded:g,onToggle:Q,toggle:oe,id:Z,size:ee,variant:v,disabled:S}),[S,g,Z,Q,ee,oe,v]);return(0,e.jsxs)(f.C.Provider,{value:te,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:S,"aria-disabled":S,expanded:g,hasRadius:!0,variant:v,error:N,shadow:de,children:u}),N&&R&&(0,e.jsx)(C.a,{paddingTop:1,children:(0,e.jsx)(A.o,{variant:"pi",textColor:"danger600",children:N})})]})}},80725:(V,$,s)=>{"use strict";s.d($,{u:()=>f});var e=s(92132),y=s(99251),b=s(44370);const f=({children:O,...A})=>{const{expanded:x,id:C}=(0,y.O)();if(!x)return null;const T=`accordion-content-${C}`,k=`accordion-label-${C}`,a=`accordion-desc-${C}`;return(0,e.jsx)(b.a,{role:"region",id:T,"aria-labelledby":k,"aria-describedby":a,...A,children:O})}},99251:(V,$,s)=>{"use strict";s.d($,{C:()=>y,O:()=>b});var e=s(21272);const y=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),b=()=>(0,e.useContext)(y)},96294:(V,$,s)=>{"use strict";s.d($,{P:()=>u});var e=s(92132),y=s(28556),b=s(63891),f=s(47098),O=s(99251);const A=({expanded:S,disabled:N,variant:g})=>{let R="neutral100";return S?R="primary100":N?R="neutral150":g==="primary"&&(R="neutral0"),R};var x=s(43274),C=s(27026),T=s(43242),k=s(57842);const a=(0,b.Ay)(x.Q)`
  text-align: left;
...
`,u=({title:S,description:N,as:g="span",togglePosition:R="right",action:Y,...Q})=>{const{onToggle:oe,toggle:ee,expanded:v,id:de,size:Z,variant:te,disabled:X}=(0,O.O)(),ue=`accordion-content-${de}`,be=`accordion-label-${de}`,Le=`accordion-desc-${de}`,ce=Z==="M"?6:4,me=Z==="M"?ce:ce-2,Te=A({expanded:v,disabled:X,variant:te}),Ae={as:g,fontWeight:Z==="S"?"bold":void 0,id:be,textColor:v?"primary600":"neutral700",ellipsis:!0,variant:Z==="M"?"delta":void 0},K=v?"primary600":"neutral600",J=v?"primary200":"neutral200",j=Z==="M"?`${32/16}rem`:`${24/16}rem`,_=()=>{X||(ee&&!oe?(console.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),ee()):oe&&oe())},re=(0,e.jsx)(T.s,{justifyContent:"center",borderRadius:"50%",height:j,width:j,transform:v?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,"aria-hidden":!0,as:"span",background:J,cursor:X?"not-allowed":"pointer",onClick:_,shrink:0,children:(0,e.jsx)(C.I,{as:y.A,width:Z==="M"?`${11/16}rem`:`${8/16}rem`,color:v?"primary600":"neutral600"})});return(0,e.jsx)(F,{paddingBottom:me,paddingLeft:ce,paddingRight:ce,paddingTop:me,background:Te,expanded:v,size:Z,justifyContent:"space-between",cursor:X?"not-allowed":"",children:(0,e.jsxs)(T.s,{gap:3,flex:1,maxWidth:"100%",children:[R==="left"&&re,(0,e.jsx)(a,{onClick:_,"aria-disabled":X,"aria-expanded":v,"aria-controls":ue,"aria-labelledby":be,"data-strapi-accordion-toggle":!0,expanded:v,type:"button",flex:1,minWidth:0,...Q,children:(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(f.I,{...Ae,children:S}),N&&(0,e.jsx)(k.o,{as:"p",id:Le,textColor:K,children:N})]})}),R==="right"&&(0,e.jsxs)(T.s,{gap:3,children:[re,Y]}),R==="left"&&Y]})})}},80846:(V,$,s)=>{"use strict";s.d($,{B:()=>f});var e=s(92132),y=s(63891),b=s(5391);const f=({options:A,...x})=>(0,e.jsx)(b.KF,{...x,children:A.map(C=>"children"in C?(0,e.jsx)(b.np,{label:C.label,values:C.children.map(T=>T.value.toString()),children:C.children.map(T=>(0,e.jsx)(O,{value:T.value,children:T.label},T.value))},C.label):(0,e.jsx)(b.fe,{value:C.value,children:C.label},C.value))}),O=(0,y.Ay)(b.fe)`
  padding-left: ${({theme:A})=>A.spaces[7]};
`},37679:(V,$,s)=>{"use strict";s.d($,{B:()=>T});var e=s(92132),y=s(21272),b=s(63891),f=s(94061),O=s(30893);const A=()=>(0,e.jsx)(f.a,{"aria-hidden":!0,paddingLeft:1,paddingRight:1,children:(0,e.jsx)(O.o,{variant:"pi",textColor:"neutral500",children:"/"})});A.displayName="Divider";var x=s(83997);const C=(0,b.Ay)(x.s)`
...
`,T=({label:k,children:a,...F})=>{const u=y.Children.toArray(a);return(0,e.jsx)(f.a,{"aria-label":k,...F,children:(0,e.jsx)(C,{as:"ol",children:y.Children.map(u,(S,N)=>{const g=u.length>1&&N+1<u.length;return(0,e.jsxs)(x.s,{inline:!0,as:"li",children:[S,g&&(0,e.jsx)(A,{})]})})})})};T.displayName="Breadcrumbs"},60043:(V,$,s)=>{"use strict";s.d($,{m:()=>f});var e=s(92132),y=s(94061),b=s(30893);const f=({children:O,isCurrent:A=!1,...x})=>(0,e.jsx)(y.a,{paddingLeft:2,paddingRight:2,paddingTop:1,paddingBottom:1,children:(0,e.jsx)(b.o,{variant:"pi",textColor:"neutral800",fontWeight:A?"bold":"normal","aria-current":A,...x,children:O})});f.displayName="Crumb"}}]);
