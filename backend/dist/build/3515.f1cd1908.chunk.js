"use strict";(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[3515],{77283:(A,M,s)=>{s.d(M,{B:()=>U,D:()=>B,H:()=>K,R:()=>y});var t=s(92132),l=s(83997),d=s(30893),P=s(42455),O=s(38413),g=s(4198),m=s(55356),a=s(55506),e=s(9005),o=s(46270),E=s(54894),c=s(18920),h=s(25524),i=s(63891);const D=(0,i.Ay)(l.s)`
  svg path {
